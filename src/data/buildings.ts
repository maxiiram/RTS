 ...
 *
 * `los` est la portée de vision : elle détermine ce que le bâtiment dévoile du
 * brouillard de guerre. La tour de garde voit plus loin qu'elle ne tire, ce qui
 * en fait autant un poste d'observation qu'une défense.
 */
